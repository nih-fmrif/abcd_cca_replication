...
# List of Mean FDs for ABCD subjects after prep_stage_1 filtering (i.e. mean FDs for subjects who have .mat files)
# fp = os.path.join(data_prep_dir,'data/stage_1/mean_FDs.txt')
# abcd_mean_fds=np.loadtxt(fp)
