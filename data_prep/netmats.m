...
addpath(genpath('../dependencies/FSLNets'));
addpath(genpath('../dependencies/L1precision'));   % L1precision toolbox
addpath(genpath('../dependencies/pwling'));        % pairwise causality toolbox
...
group_maps='mini_groupICA200.ica/melodic_IC';     % spatial maps 4D NIFTI file, e.g. from group-ICA
...
ts_dir='mini_groupICA200.dr';                           % dual regression output directory, containing all subjects' timeseries
